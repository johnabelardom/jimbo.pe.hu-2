...
.dashboard {
  ...
  box-shadow: 5px 5px 20px #555;
		...
		<div class="primary-content" style="padding: 0 !important;">
      <button class="pathways funcBTNS">
        <span>Path to PHP Developer</span>
      </button>
			<!-- <p>THIS THE DASHBOARD</p>
 -->			<div class="dashboard display-animation" style="margin: 0 auto; width: 100%; max-width: 100%; display: none;">
    ...
    <span class="content-wrapper">
      <span class="tile-content">
        ...
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn HTML</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-purple ripple-effect" href="http://www.w3schools.com/css/default.asp" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        ...
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn CSS</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-cyan ripple-effect" href="http://www.w3schools.com/js/default.asp" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img" style="background-image: url(http://www.google.com/design/images/principles.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn Javascript<span class="caption"></span></span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-amber ripple-effect" href="http://www.w3schools.com/jquery/default.asp" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img tile-img-bg" style="background-image: url(http://www.google.com/design/images/doodlearchive.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn Jquery</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-light-blue ripple-effect" href="http://www.w3schools.com/sql/default.asp" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img tile-img-bg" style="background-image: url(http://www.google.com/design/images/googleplus.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn SQL</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-red ripple-effect" href="http://www.w3schools.com/php/default.asp" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img" style="background-image: url(http://www.google.com/design/images/design-minutes.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn PHP</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-indigo ripple-effect" href="http://www.tutorialspoint.com/codeigniter/" target="_blank">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img" style="background-image: url(http://www.google.com/design/images/cast.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Learn Codeigniter</span>
        </span>
      </span>      
    </span>
  </a>
  <a class="tile tile-lg tile-sqr tile-deep-orange ripple-effect" href="http://www.facebook.com/johnabelardom">
    <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-img" style="background-image: url(http://www.google.com/design/images/glass.png);"></span>
        <span class="tile-holder tile-holder-sm">
          <span class="title">Contact Creator</span>
        </span>
      </span>      
    </span>
  </a>
...
<script>
	...
	// 	jQuery(this).attr('href', 'dashboard/logoutuser');
	// });
/**
 ...
 */
jQuery('.pathways').click(function() {
  jQuery('.dashboard').fadeToggle();//function() {
